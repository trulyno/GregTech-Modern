...
import static com.gregtechceu.gtceu.common.block.variant.BoilerFireBoxCasingBlock.CasingType.*;
import static com.gregtechceu.gtceu.common.block.variant.CoilBlock.CoilType.*;
...
public class MetaTileEntityLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        // TODO Fluid stuff? also move to config loaded recipe classes
        /*
        if (ConfigHolder.recipes.harderBrickRecipes) {
            VanillaRecipeHelper.addFluidReplaceRecipe("bucket_of_concrete", FluidUtil.getFilledBucket(GTMaterials.Concrete.getFluid(1000)),
                    "C S", "CWQ", " L ",
                    'C', new UnificationEntry(TagPrefix.dust, GTMaterials.Calcite),
                    'S', new UnificationEntry(TagPrefix.dust, GTMaterials.Stone),
                    'W', new ItemStack(Items.WATER_BUCKET),
                    'Q', new UnificationEntry(TagPrefix.dust, GTMaterials.QuartzSand),
                    'L', new UnificationEntry(TagPrefix.dust, GTMaterials.Clay));

            VanillaRecipeHelper.addShapedRecipe(provider, "casing_primitive_bricks", GTBlocks.CASING.get().getItemVariant(PRIMITIVE_BRICKS),
                    "BGB", "BCB", "BGB",
                    'B', GTItems.FIRECLAY_BRICK.asStack(),
                    'G', new UnificationEntry(TagPrefix.dust, GTMaterials.Gypsum),
                    'C', FluidUtil.getFilledBucket(GTMaterials.Concrete.getFluid(1000)));
        } else {
            VanillaRecipeHelper.addShapedRecipe(provider, "casing_primitive_bricks", GTBlocks.CASING.get().getItemVariant(PRIMITIVE_BRICKS, 1), "XX", "XX", 'X', GTItems.FIRECLAY_BRICK);
        }
         */
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "casing_bronze_firebox", GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(BRONZE_FIREBOX, 2), "PSP", "SFS", "PSP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Bronze), 'F', new UnificationEntry(TagPrefix.frameGt, GTMaterials.Bronze), 'S', new UnificationEntry(TagPrefix.stick, GTMaterials.Bronze));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "casing_steel_firebox", GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(STEEL_FIREBOX, 2), "PSP", "SFS", "PSP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Steel), 'F', new UnificationEntry(TagPrefix.frameGt, GTMaterials.Steel), 'S', new UnificationEntry(TagPrefix.stick, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "casing_titanium_firebox", GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(TITANIUM_FIREBOX, 2), "PSP", "SFS", "PSP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Titanium), 'F', new UnificationEntry(TagPrefix.frameGt, GTMaterials.Titanium), 'S', new UnificationEntry(TagPrefix.stick, GTMaterials.Titanium));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "casing_tungstensteel_firebox", GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(TUNGSTENSTEEL_FIREBOX, 2), "PSP", "SFS", "PSP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.TungstenSteel), 'F', new UnificationEntry(TagPrefix.frameGt, GTMaterials.TungstenSteel), 'S', new UnificationEntry(TagPrefix.stick, GTMaterials.TungstenSteel));
        ...
        */
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_hammer_bronze", GTMachines.STEAM_HAMMER.left().asStack(), "XPX", "XMX", "XAX", 'M', GTBlocks.BRONZE_HULL.asStack(), 'X', new UnificationEntry(TagPrefix.pipeSmallFluid, GTMaterials.Bronze), 'P', new UnificationEntry(TagPrefix.crafting, MarkerMaterials.Misc.Piston), 'A', Blocks.ANVIL);
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_compressor_bronze", GTMachines.STEAM_COMPRESSOR.left().asStack(), "XXX", "PMP", "XXX", 'M', GTBlocks.BRONZE_HULL.asStack(), 'X', new UnificationEntry(TagPrefix.pipeSmallFluid, GTMaterials.Bronze), 'P', new UnificationEntry(TagPrefix.crafting, MarkerMaterials.Misc.Piston));
        ...
        // todo drums
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "coke_oven_hatch", GTMachines.COKE_OVEN_HATCH.asStack(), "CD", 'C', GTBlocks.CASING.get().getItemVariant(COKE_BRICKS), 'D', GTMachines.WOODEN_DRUM.getStackForm());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "cracking_unit", GTMachines.CRACKER.asStack(), "CEC", "PHP", "CEC", 'C', GTBlocks.WIRE_COIL.get().getItemVariant(CUPRONICKEL), 'E', GTItems.ELECTRIC_PUMP_HV.asStack(), 'P', new UnificationEntry(TagPrefix.circuit, Tier.HV), 'H', GTMachines.HULL[GTValues.HV].asStack());
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_bronze_boiler", GTMachines.LARGE_BOILER_BRONZE.asStack(), "PSP", "SAS", "PSP", 'P', new UnificationEntry(TagPrefix.cableGtSingle, GTMaterials.Tin), 'S', new UnificationEntry(TagPrefix.circuit, Tier.LV), 'A', GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(BRONZE_FIREBOX));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_steel_boiler", GTMachines.LARGE_BOILER_STEEL.asStack(), "PSP", "SAS", "PSP", 'P', new UnificationEntry(TagPrefix.cableGtSingle, GTMaterials.Copper), 'S', new UnificationEntry(TagPrefix.circuit, Tier.HV), 'A', GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(STEEL_FIREBOX));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_titanium_boiler", GTMachines.LARGE_BOILER_TITANIUM.asStack(), "PSP", "SAS", "PSP", 'P', new UnificationEntry(TagPrefix.cableGtSingle, GTMaterials.Gold), 'S', new UnificationEntry(TagPrefix.circuit, Tier.EV), 'A', GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(TITANIUM_FIREBOX));
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_tungstensteel_boiler", GTMachines.LARGE_BOILER_TUNGSTENSTEEL.asStack(), "PSP", "SAS", "PSP", 'P', new UnificationEntry(TagPrefix.cableGtSingle, GTMaterials.Aluminium), 'S', new UnificationEntry(TagPrefix.circuit, Tier.IV), 'A', GTBlocks.BOILER_FIREBOX_CASING.get().getItemVariant(TUNGSTENSTEEL_FIREBOX));
        ...
        registerMachineRecipe(provider, GTMachines.PACKER, "BCB", "RMV", "WCW", 'M', HULL, 'R', ROBOT_ARM, 'V', CONVEYOR, 'C', CIRCUIT, 'W', CABLE, 'B', CommonTags.TAG_WOODEN_CHESTS);
        ...
        registerMachineRecipe(provider, GTMachines.FLUID_SOLIDIFIER, "PGP", "WMW", "CBC", 'M', HULL, 'P', PUMP, 'C', CIRCUIT, 'W', CABLE, 'G', GLASS, 'B', CommonTags.TAG_WOODEN_CHESTS);
        ...
        registerMachineRecipe(provider, GTMachines.BATTERY_BUFFER_4, "WTW", "WMW", 'M', HULL, 'W', WIRE_QUAD, 'T', CommonTags.TAG_WOODEN_CHESTS);
        registerMachineRecipe(provider, GTMachines.BATTERY_BUFFER_8, "WTW", "WMW", 'M', HULL, 'W', WIRE_OCT, 'T', CommonTags.TAG_WOODEN_CHESTS);
        registerMachineRecipe(provider, GTMachines.BATTERY_BUFFER_16, "WTW", "WMW", 'M', HULL, 'W', WIRE_HEX, 'T', CommonTags.TAG_WOODEN_CHESTS);
        ...
        registerMachineRecipe(provider, GTMachines.ITEM_IMPORT_BUS, " C", " M", 'M', HULL, 'C', CommonTags.TAG_WOODEN_CHESTS);
        registerMachineRecipe(provider, GTMachines.ITEM_EXPORT_BUS, " M", " C", 'M', HULL, 'C', CommonTags.TAG_WOODEN_CHESTS);

        // TODO Crates
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "wooden_crate", GTMachines.WOODEN_CRATE.getStackForm(), "RPR", "PsP", "RPR", 'P', "plankWood", 'R', new UnificationEntry(TagPrefix.screw, GTMaterials.Iron));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "bronze_crate", GTMachines.BRONZE_CRATE.getStackForm(), "RPR", "PhP", "RPR", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Bronze), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Bronze));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "steel_crate", GTMachines.STEEL_CRATE.getStackForm(), "RPR", "PhP", "RPR", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Steel), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Steel));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "aluminium_crate", GTMachines.ALUMINIUM_CRATE.getStackForm(), "RPR", "PhP", "RPR", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Aluminium), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Aluminium));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "stainless_steel_crate", GTMachines.STAINLESS_STEEL_CRATE.getStackForm(), "RPR", "PhP", "RPR", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.StainlessSteel), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.StainlessSteel));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "titanium_crate", GTMachines.TITANIUM_CRATE.getStackForm(), "RPR", "PhP", "RPR", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Titanium), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Titanium));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "tungstensteel_crate", GTMachines.TUNGSTENSTEEL_CRATE.getStackForm(), "RPR", "PhP", "RPR", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.TungstenSteel), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.TungstenSteel));

        // TODO Drums
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "wooden_barrel", GTMachines.WOODEN_DRUM.getStackForm(), "rSs", "PRP", "PRP", 'S', MetaItems.STICKY_RESIN.getStackForm(), 'P', "plankWood", 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Iron));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "bronze_drum", GTMachines.BRONZE_DRUM.getStackForm(), " h ", "PRP", "PRP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Bronze), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Bronze));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "steel_drum", GTMachines.STEEL_DRUM.getStackForm(), " h ", "PRP", "PRP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Steel), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Steel));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "aluminium_drum", GTMachines.ALUMINIUM_DRUM.getStackForm(), " h ", "PRP", "PRP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Aluminium), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.Aluminium));
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "stainless_steel_drum", GTMachines.STAINLESS_STEEL_DRUM.getStackForm(), " h ", "PRP", "PRP", 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.StainlessSteel), 'R', new UnificationEntry(TagPrefix.stickLong, GTMaterials.StainlessSteel));
        ...
        // TODO crates
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "super_chest_lv", GTMachines.SUPER_CHEST[0].asStack(), "CPC", "PFP", "CPC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.LV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Steel), 'F', GTMachines.STEEL_CRATE.getStackForm());
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "super_chest_mv", GTMachines.SUPER_CHEST[1].asStack(), "CPC", "PFP", "CPC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.MV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Aluminium), 'F', GTMachines.ALUMINIUM_CRATE.getStackForm());
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "super_chest_hv", GTMachines.SUPER_CHEST[2].asStack(), "CPC", "PFP", "CGC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.HV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.StainlessSteel), 'F', GTMachines.STAINLESS_STEEL_CRATE.getStackForm(), 'G', GTItems.FIELD_GENERATOR_LV.asStack());
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "super_chest_ev", GTMachines.SUPER_CHEST[3].asStack(), "CPC", "PFP", "CGC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.EV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Titanium), 'F', GTMachines.TITANIUM_CRATE.getStackForm(), 'G', GTItems.FIELD_GENERATOR_MV.asStack());
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "super_chest_iv", GTMachines.SUPER_CHEST[4].asStack(), "CPC", "PFP", "CGC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.IV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.TungstenSteel), 'F', GTMachines.TUNGSTENSTEEL_CRATE.getStackForm(), 'G', GTItems.FIELD_GENERATOR_HV.asStack());

        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_chest_iv", GTMachines.QUANTUM_CHEST[0].asStack(), "CPC", "PHP", "CFC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.IV), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.TungstenSteel), 'F', GTItems.FIELD_GENERATOR_EV.asStack(), 'H', GTMachines.HULL[5].asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_chest_luv", GTMachines.QUANTUM_CHEST[1].asStack(), "CPC", "PHP", "CFC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.LuV), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.RhodiumPlatedPalladium), 'F', GTItems.FIELD_GENERATOR_IV.asStack(), 'H', GTMachines.HULL[6].asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_chest_zpm", GTMachines.QUANTUM_CHEST[2].asStack(), "CPC", "PHP", "CFC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.ZPM), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.NaquadahAlloy), 'F', GTItems.FIELD_GENERATOR_LuV.asStack(), 'H', GTMachines.HULL[7].asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_chest_uv", GTMachines.QUANTUM_CHEST[3].asStack(), "CPC", "PHP", "CFC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.UV), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.Darmstadtium), 'F', GTItems.FIELD_GENERATOR_ZPM.asStack(), 'H', GTMachines.HULL[8].asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_chest_uhv", GTMachines.QUANTUM_CHEST[4].asStack(), "CPC", "PHP", "CFC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.UHV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Neutronium), 'F', GTItems.FIELD_GENERATOR_UV.asStack(), 'H', GTMachines.HULL[9].asStack());
        ...
        //VanillaRecipeHelper.addShapedRecipe(provider, true, "super_tank_iv", GTMachines.SUPER_TANK[4].asStack(), "CGC", "PHP", "CFC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.IV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.TungstenSteel), 'F', GTItems.ELECTRIC_PUMP_IV.asStack(), 'H', GTBlocks.HERMETIC_CASING.get().getItemVariant(HERMETIC_IV), 'G', GTItems.FIELD_GENERATOR_HV.asStack());

        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_tank_iv", GTMachines.QUANTUM_TANK[0].asStack(), "CGC", "PHP", "CUC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.IV), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.TungstenSteel), 'U', GTItems.ELECTRIC_PUMP_IV.asStack(), 'G', GTItems.FIELD_GENERATOR_EV.asStack(), 'H', GTBlocks.HERMETIC_CASING_IV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_tank_luv", GTMachines.QUANTUM_TANK[1].asStack(), "CGC", "PHP", "CUC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.LuV), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.RhodiumPlatedPalladium), 'U', GTItems.ELECTRIC_PUMP_LuV.asStack(), 'G', GTItems.FIELD_GENERATOR_IV.asStack(), 'H', GTBlocks.HERMETIC_CASING_LuV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_tank_zpm", GTMachines.QUANTUM_TANK[2].asStack(), "CGC", "PHP", "CUC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.ZPM), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.NaquadahAlloy), 'U', GTItems.ELECTRIC_PUMP_ZPM.asStack(), 'G', GTItems.FIELD_GENERATOR_LuV.asStack(), 'H', GTBlocks.HERMETIC_CASING_ZPM.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_tank_uv", GTMachines.QUANTUM_TANK[3].asStack(), "CGC", "PHP", "CUC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.UV), 'P', new UnificationEntry(TagPrefix.plateDense, GTMaterials.Darmstadtium), 'U', GTItems.ELECTRIC_PUMP_UV.asStack(), 'G', GTItems.FIELD_GENERATOR_ZPM.asStack(), 'H', GTBlocks.HERMETIC_CASING_UV.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, true, "quantum_tank_uhv", GTMachines.QUANTUM_TANK[4].asStack(), "CGC", "PHP", "CUC", 'C', new UnificationEntry(TagPrefix.circuit, Tier.UHV), 'P', new UnificationEntry(TagPrefix.plate, GTMaterials.Neutronium), 'U', GTItems.ELECTRIC_PUMP_UV.asStack(), 'G', GTItems.FIELD_GENERATOR_UV.asStack(), 'H', GTBlocks.HERMETIC_CASING_UHV.asStack());
        ...
        if (ConfigHolder.recipes.harderEBFControllerRecipe) {
            VanillaRecipeHelper.addShapedRecipe(provider, true, "electric_blast_furnace", GTMachines.ELECTRIC_BLAST_FURNACE.asStack(),
                    "FFF", "CHC", "WCW",
                    'F', GTMachines.ELECTRIC_FURNACE[1].asStack(),
                    'C', new UnificationEntry(TagPrefix.circuit, Tier.LV),
                    'H', GTBlocks.CASING_INVAR_HEATPROOF.asStack(),
